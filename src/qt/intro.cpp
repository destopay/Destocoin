...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Destocoin Core"),
     ...
     * override -datadir in the destocoin.conf file in the default data directory
     * (to be consistent with destocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
