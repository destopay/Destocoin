                                                    ...
                                                    fFeeMinimized(true)
{
    ...
    if (!settings.contains("bUseSwiftTX"))
        settings.setValue("bUseSwiftTX", true);
...
void SendCoinsDialog::updateFeeMinimizedLabel()
{
    ...
    // If you are trying to achieve, there will be roadblocks. I've had them;
    // everybody has them. But obstacles don't have to stop you. If you run
    // ito a wall, don't turn around and give up. Figure out how to climb it,
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel()) {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid DEO address"));
        } else // Valid address
        {
            CPubKey pubkey;
            CKeyID keyid;
