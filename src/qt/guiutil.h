...
/** Utility functions used by the Destocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DEO addresses in monospace font
...
// Parse "destocoin:" URI into recipient object, return true on successful parsing
