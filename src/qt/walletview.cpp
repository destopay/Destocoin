                                          ...
                                          walletModel(0)
{
    ...
    transactionsPage->setObjectName("TransactionPage"); // Label ID as CSS-reference
    ...
    verticalLayout_8->setObjectName(QStringLiteral("verticalLayout_Header"));
    ...
    QSpacerItem* horizontalSpacer_3 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Maximum);
