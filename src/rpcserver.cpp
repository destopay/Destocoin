...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Destocoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Destocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Destocoin features */
        {"destocoin", "masternode", &masternode, true, true, false},
        {"destocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"destocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"destocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"destocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"destocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"destocoin", "startmasternode", &startmasternode, true, true, false},
        {"destocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"destocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"destocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"destocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"destocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"destocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"destocoin", "mnbudget", &mnbudget, true, true, false},
        {"destocoin", "preparebudget", &preparebudget, true, true, false},
        {"destocoin", "submitbudget", &submitbudget, true, true, false},
        {"destocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"destocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"destocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"destocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"destocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"destocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"destocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"destocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"destocoin", "mnsync", &mnsync, true, true, false},
        {"destocoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> destocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9933/\n";
}
