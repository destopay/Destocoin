...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Destocoin Core destocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  destocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Destocoin transaction") + "\n" +
                               "  destocoin-tx [options] -create [commands]   " + _("Create hex-encoded Destocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Destocoin transaction
