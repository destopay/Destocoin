Contributing to Destocoin Core
==================================

The Destocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Destocoin Core project, and is not to be
confused with overall Destocoin Network Protocol consensus changes.

Whether a pull request is merged into Destocoin Core rests with the project merge
...
Patches that change Destocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Destocoin consensus, it must have been
...
The project leader is the release manager for each Destocoin Core release.
