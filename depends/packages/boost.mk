...
#1.66 has issues with error: invalid use of incomplete type ‘class std::promise<void>’
#but maybe solvable using posix instead of win32 gcc
...
#$(package)_cxxflags_darwin=-I$(OSX_SDK)/usr/include
endef
