...
This mechanism has been integrated into Bitcore-Node-Destocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/destocoin/insight-api-destocoin#web-socket-api](https://github.com/destocoin/insight-api-destocoin#web-socket-api)
* API: [https://github.com/destocoin/insight-api-destocoin#swifttx-transactions](https://github.com/destocoin/insight-api-destocoin#swifttx-transactions)
...
By default, the Destocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Destocoin Core daemon:
