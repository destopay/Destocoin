...
In order to support loading of multiple wallets in destocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is destocoin.cpp.
...
Changes to destocoin.cpp
----------------------
destocoin.cpp is the entry point into destocoin-qt, and as such, will require some minor modifications to provide hooks for
