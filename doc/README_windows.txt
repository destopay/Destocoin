...
Intro
-----
Destocoin (DEO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Destocoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run destocoin-qt.exe.

Destocoin Core is the original Destocoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Destocoin transactions;
