...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/destocoin-cli.cpp \
           src/destocoin-tx.cpp \
           src/destocoin.cpp \
           src/db.cpp \
           ...
           src/qt/destocoin.cpp \
           src/qt/destocoinstrings.cpp \
...
RESOURCES += src/qt/destocoin.qrc src/qt/destocoin_locale.qrc

TRANSLATIONS += src/qt/locale/destocoin_bg.ts \
                src/qt/locale/destocoin_de.ts \
                src/qt/locale/destocoin_en.ts \
                src/qt/locale/destocoin_es.ts \
                src/qt/locale/destocoin_fi.ts \
                src/qt/locale/destocoin_fr.ts \
                src/qt/locale/destocoin_it.ts \
                src/qt/locale/destocoin_ja.ts \
                src/qt/locale/destocoin_pl.ts \
                src/qt/locale/destocoin_pt.ts \
                src/qt/locale/destocoin_ru.ts \
                src/qt/locale/destocoin_sk.ts \
                src/qt/locale/destocoin_sv.ts \
                src/qt/locale/destocoin_vi.ts \
                src/qt/locale/destocoin_zh_CN.ts \
                src/qt/locale/destocoin_zh_TW.ts
