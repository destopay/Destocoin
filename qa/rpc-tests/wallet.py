...
#   c) node1 mines 32 blocks, so now node 0 has 500000DEO, node 1 has 4250DEO, node2 has none.
#   d) node0 sends 601 DEO to node2, in two transactions (301 DEO, then 300 DEO).
